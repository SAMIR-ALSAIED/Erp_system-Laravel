						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								...
								<div class="tx-12 tx-gray-500 mb-2">
                                    {{-- @if (auth()->user()->roles_name=="molzem") --}}

                                    @can('اضافة فاتورة')



        <a href="{{route('invoices.create')}}" class="btn  btn-primary  p-2 " ><i class="fas fa-plus"></i>&nbsp; اضافة فاتورة</a>
            @endcan
...
<td class="text-center">
    <div class="dropdown">
        <button class="btn btn-primary btn-sm border-0 shadow-sm" type="button"
                id="dropdownMenu{{ $invoice->id }}" data-bs-toggle="dropdown"
                aria-expanded="false" title="خيارات">
        ...
        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg rounded-3 p-2"
            ...
            <!-- عرض الفاتورة -->
            {{-- <li>
                <a class="dropdown-item d-flex align-items-center py-2 rounded-2 hover-bg-light"
                   href="{{ route('InvoicesDetails.show', $invoice->id) }}">
                    <i class="bx bx-show text-primary fs-5 me-2"></i>
                    <span>عرض الفاتورة</span>
                </a>
            ...
            {{-- <li>
                <a class="dropdown-item d-flex align-items-center py-2 rounded-2"
                   href="{{ route('Invoices.show', $invoice->id) }}">
                    <i class="bx bx-refresh text-warning fs-5 me-2"></i>
                    <span>تعديل حالة الفاتورة</span>
                </a>
            </li> --}}
            ...
            <li>
                <a class="dropdown-item d-flex align-items-center py-2 rounded-2"
                   href="{{ route('invoices.show', $invoice->id) }}">
                    <i class="bx bx-refresh text-success fs-5 me-2"></i>
