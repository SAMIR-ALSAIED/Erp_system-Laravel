									...
									<table id="example1" class="table table-bordered text-center  table-hover ">
										...
										<thead class="">
											<tr>
												...
												<th class="bg-primary text-white">القسم</th>

                                            	<th class="bg-primary text-white">ملاحظات  </th>
										...
										<tbody>
											...
											<tr>
												...
												<td>{{$cat->description	??'لا يوجد '}}</td>
										      <td>{{ $cat->created_at->timezone('Africa/Cairo')->translatedFormat('m-d-Y ') }}</td>
     ...
     @endcan
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <!-- الهيدر -->
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title text-white" id="editModalLabel{{ $cat->id }}">تعديل القسم</h5>
                </div>
